...
print("x and Y logical operators:",(x and y)) #here both values(condition) should be True
print("x or y logical operators:",(x or y))   #Here one value(condition) should be True
print("not logical operators:",not y)
