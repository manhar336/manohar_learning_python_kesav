#Tuple can write as  ''(single code),""(double code),''''''(single triple),""""""(double triple) and should be comma seperated

tuple1 = ('ats',"bts",'''prod''',"""acceptance""")
print(tuple1,type(tuple1),id(tuple1),len(tuple1))

tuple2 = 'ats','bts','prod'
print(tuple2,type(tuple2),len(tuple2))

tuple3 = ('ats',1.25,'bts',2.25,'prod',10)
print(tuple3,type(tuple3),len(tuple3),id(tuple3))  #tuples can allow strings and numbers

print(tuple(enumerate(tuple1)))  #enumerate is built in function to give index value for each value
print(tuple(enumerate(tuple2)))
